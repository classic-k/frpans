...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowNativeBalance, onDismiss }) => {
  ...
  const { balance: wNativeBalance, fetchStatus: wNativeFetchStatus } = { wNativeBalance:0.0, wNativeFetchStatus:1 } //useTokenBalance(wNativeToken?.address)
  const { balance: wBNBBalance, fetchStatus: wBNBFetchStatus } = { wBNBBalance:1.2, wBNBFetchStatus:1 } //useTokenBalance(wBNBToken?.address, true)
  const { balance: cakeBalance, fetchStatus: cakeFetchStatus } = { cakeBalance:3.1, cakeFetchStatus:1 } //useGetCakeBalance()
