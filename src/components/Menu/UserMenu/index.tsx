...
const UserMenuItems = () => {
 // const { t } = useTranslation()
  ...
  //const { hasPendingTransactions } = {false}//usePendingTransactions()
  const hasPendingTransactions = false
  const { isInitialized, isLoading, profile } = {isInitialized:false, isLoading:false, profile: {}}//useProfile()
  ...
  return (
    <ConnectWalletButton scale="sm">
      ...
      <Box display={['block', , , 'none']}>
        {"Connect Wallet" || <Trans>Connect</Trans>}
      </Box>
    </ConnectWalletButton>
  )
}
