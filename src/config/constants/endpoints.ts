...
export const API_PROFILE ="http://localhost:3000/profile" //'https://profile.pancakeswap.com'
...
export const BIT_QUERY = "http://localhost:3000/bit"//'https://graphql.bitquery.io'
...
export const ASSET_CDN ="http://localhost:3000" //'https://assets.pancakeswap.finance'
